package com.dream.pay.center.refund.handler;
...
import com.dream.pay.center.refund.enums.RefundStatusEnum;
import com.dream.pay.center.refund.enums.RefundTaskEnum;
import com.dream.pay.center.refund.fsm.RefundFSM;
...
public class RefundApplyHandler extends
    ...
    private FundsRefundJobEntity composeRefundJob(FundsRefundDetailEntity fundsRefundDetailEntity) {
        ...
        fundsRefundJobEntity.setJobStatus(JobStatus.TODO.getCode());
