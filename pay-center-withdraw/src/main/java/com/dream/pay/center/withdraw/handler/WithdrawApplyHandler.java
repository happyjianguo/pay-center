package com.dream.pay.center.withdraw.handler;
...
import com.dream.pay.center.withdraw.enums.WithdrawStatusEnum;
import com.dream.pay.center.withdraw.enums.WithdrawTaskEnum;
import com.dream.pay.center.withdraw.fsm.WithdrawFSM;
import lombok.Data;
...
public class WithdrawApplyHandler extends
    ...
    protected WithdrawApplyResult execute(WithdrawApplyRequest withdrawApplyRequest) {
        ...
        //获取银行卡信息
        BankCardInfoResult bankCardInfo = merchantService.queryCardInfo(withdrawApplyRequest.getMerchantNo(), withdrawApplyRequest.getCardBindId(), com.dream.pay.enums.BizActionEnum.WITHDRAW.getCode());
    ...
    private FundsWithdrawJobEntity composeWithdrawJob(FundsWithdrawDetailEntity withdrawDetailEntity, FundsTradeItemsEntity fundsTradeItemsEntity) {
        ...
        fundsWithdrawJobEntity.setJobStatus(JobStatus.TODO.getCode());
